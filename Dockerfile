...
sed -i "s|<Valve className=\"org.apache.catalina.valves.AccessLogValve\"|<Valve className=\"org.apache.catalina.valves.RemoteIpValve\" remoteIpHeader=\"x-forwarded-for\" protocolHeader=\"x-forwarded-proto\" />\\n        <Valve className=\"org.apache.catalina.valves.AccessLogValve\"|" /usr/local/tomcat/conf/server.xml\n\
